...
/**
 * Returnerar { milestone, date } för varje 100:e månad bakåt från idag.
 */
export function getMonthMilestoneDates() {
  const today = new Date();

  return Array.from({ length: 10 }, (_, i) => {
    const monthsAgo = (i + 1) * -100;
 ...
 */
export function getMilestoneDatesFromBirthdate(birthdateStr) {
